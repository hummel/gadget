...
c
/*from param.h in ZEUSMP for FORTRAN files*/
...
c 
...
#endif
#ifdef METALS_TG
      REAL abratio_c, abratio_o, abratio_si
#endif

      integer iphoto, iflag_mn, iflag_ad, iflag_atom, 
     $        iflag_3bh2a, iflag_3bh2b, iflag_h3pra,
     $        iflag_h2opc, iflag_highT, iflag_fixed_ion, ipart_id
#ifdef TEST
      integer itest
#endif /* TEST */
#ifdef RAYTRACE_TG
     ...
     $               cosmic_ray_ion_rate, redshift, AV_ext, HM, H2II
#ifdef METALS_TG
     $,              abratio_c, abratio_o, abratio_si
#endif
#ifdef RAYTRACE_TG
     $,              ray_H_coeff, ray_He_coeff, ray_LW_coeff, ray_NH2
#endif
