...
#ifdef POLYTROPE
  printf("Polytropic EOS not implemented for comoving simulations!\n");
  endrun(100);
  return 0;
#else
  /* We assume here that gamma = 5/3; taking H2 into account would be difficult and
