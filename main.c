...
int main(int argc, char **argv)
{
  ...
  All.CPU_TreeConstruction = All.CPU_TreeWalk = All.CPU_Gravity = All.CPU_Potential = All.CPU_Domain =
    ...
    All.CPU_EnsureNgb = All.CPU_Predict = All.CPU_TimeLine = All.CPU_PM = All.CPU_Peano = All.CPU_Sinks = 0;

#ifdef TURBULENCE
  All.CPU_Turbulence = 0;
#endif 
#ifdef CHEMCOOL
  All.CPU_Chemcool = 0;
#ifdef RAYTRACE
...
- \b OUTPUTPRESSURE \n Dump the pressure as well as the internal energy
...
- \b ISOTHERM_EQS \n This special option makes the gas behave like an
     ...
     initial conditions, i.e. \f$ c_s^2=u \f$. If the value for \f$ u \f$ is
