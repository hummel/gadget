...
int N_sinks;		/*!< number of sink particles on the LOCAL processor  */
long long Ntype[numtype];      /*!< total number of particles of each type */
int NtypeLocal[numtype];       /*!< local number of particles of each type */
...
#ifdef RAYTRACE
FLOAT density_H[NCOL][NCOL][NCOL];
FLOAT density_H2[NCOL][NCOL][NCOL];
FLOAT RTbuffer[NCOL][NCOL][NCOL];
FLOAT column_H[6][NCOL][NCOL][NCOL];
FLOAT column_H2[6][NCOL][NCOL][NCOL];
#ifdef CO_SHIELDING
FLOAT density_CO[NCOL][NCOL][NCOL];
FLOAT column_CO[6][NCOL][NCOL][NCOL];
#endif
#endif /* RAYTRACE */
